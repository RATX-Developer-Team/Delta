            ...
            <div class="row ">
                <article class="card col-md-4">
                    <figure class="mb-5 text-center position-relative card-img-top">
                        <img src="./img/foto.png" class="img-fluid rounded" alt="Noticia Mundial" />
                        <div class="tags position-absolute bottom-0 end-0 mb-0 text-white w-100">
                            <p class="fs-5 mb-0">
                                <i class="fa-solid fa-eye"></i>
                                <h:outputText value="376" styleClass="me-2"/>
                                <i class="fa-solid fa-calendar"></i>
                                <h:outputText value="19/02/2022" />
                            </p>
                        </div>
                    </figure>
                    <div class="card-body">
                        <header>
                            <p>
                                <h:outputText value="Título" styleClass="card-title h3 fw-bold mb-1"/>  
                            </p>
                            <p>
                                <h:outputText value="Lorem ipsum dolor sit, amet consectetur adipisicing elit. Amet accusamus dolore maxime, debitis ab quam." styleClass="h4 mb-1"/>  
                            </p>
                        </header>
                     </div>
                </article>
                <article class="card col-md-4">
                    ...
                    <div class="card-body">
                        <header>
                            <p>
                                <h:outputText value="#{beanArticulo.articulo.titular}" styleClass="card-title h1 fw-bold mb-1"/>  
                            </p>
                            <p>
