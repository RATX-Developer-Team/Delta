        ...
        <body>
            <div class="d-flex">
                ...
                <div id="content-wrapper" class="d-flex flex-column w-100">
                    ...
                    <div>
                        <header class="align-self-center fs-1 text-center fw-bold">Control de usuarios</header>
                        <div class="w-75 p-3 m-auto">
                        <h:form>
                            <h:dataTable styleClass="tablaPlugin" value="#{beanAdministracion.listaUsuarios}" var="u" binding="#{beanAdministracion.tablaUsuarios}">
                                <h:column>
                                    <f:facet name="header">
                                ...
                                <h:column>
                                    ...
                                    <h:outputText value="Editor" rendered="#{u.permiso==1}"/>
                                    <h:outputText value="Administrador" rendered="#{u.permiso==2}"/>
                                    <h:outputText value="Lector" rendered="#{u.permiso==0 || u.permiso==null}"/>
                                </h:column>
                                <h:column>
                                    <h:commandButton styleClass="btn btn-fondoPer" value="Permiso" actionListener="#{beanAdministracion.cambiarPermisoUsu()}"/>
                                </h:column>
                                <h:column>
                                    <h:commandButton styleClass="btn btn-danger" value="Eliminar" actionListener="#{beanAdministracion.eliminarUsu()}"/>
                                </h:column>
                            </h:dataTable>
                        </h:form>
                        </div>
