...
-- Dumping data for table dbperiodico.articulo: ~11 rows (approximately)
...
-- Dumping data for table dbperiodico.opinion: ~7 rows (approximately)
...
-- Dumping data for table dbperiodico.respuestas: ~4 rows (approximately)
...
INSERT INTO `usuario` (`email`, `cod_usuario`, `fecha_nacimiento`, `pais`, `nombre`, `apellidos`, `password`, `permiso`) VALUES
	('admin@delta.es', 6, '2022-03-09', 'USA', 'Myke', 'Towers', 'YAgIFasDMz4=', 2),
	('editor@delta.es', 8, '2022-03-10', 'España', 'Alejandro', 'Mendoza', 'YAgIFasDMz4=', 1),
	('prueba@gmail.com', 5, '2022-03-09', 'USA', 'Chencho', 'Corleone', 'YAgIFasDMz4=', NULL);
