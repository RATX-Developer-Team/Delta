...
-- Volcando datos para la tabla dbperiodico.articulo: ~2 rows (aproximadamente)
...
-- Volcando datos para la tabla dbperiodico.categorias: ~6 rows (aproximadamente)
...
-- Volcando estructura para tabla dbperiodico.newletter
...
-- Volcando datos para la tabla dbperiodico.newletter: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla dbperiodico.opinion: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla dbperiodico.respuestas: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla dbperiodico.subcategorias: ~0 rows (aproximadamente)
